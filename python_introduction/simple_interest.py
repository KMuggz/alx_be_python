"""
    ...
    Expected Output:
    When executed, your script should print the simple interest calculated with the provided values. For principal = 1000, rate = 0.05, and time = 3
"""

# This is a simple script to calculate simple interest
principal = 1000  # Principal amount in $
rate = 0.05       # This represents 5% annual interest rate (as a decimal)
...
# Expected Output: Successful execution with printed results
